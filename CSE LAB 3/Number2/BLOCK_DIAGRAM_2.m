...
tfnum = G1_tf*G2_tf*G3_tf*G4_tf;

tfden = (1 + (G1_tf*G2_tf*G3_tf*G4_tf*H1_tf) + (G2_tf*G3_tf*H2_tf) + (G3_tf*G4_tf*H3_tf));

Tf_final = tfnum/tfden

%% Coefficient Convertion
Tf_num_final=[4 -4 -12 4 8 0 0 0 0 0 0 0 0];
Tf_den_final=[8 0 -32 -4 32 -8 -20 -8 -12 4 8 0 0 0 0 0 0 0];
